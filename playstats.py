...
def process_playstats(pbp, seasons):
    """
    ...
    playstats = playstats.drop_duplicates(
        subset=["game_id", "play_id", "gsis_player_id", "stat_id"]
    )
    ...
    result["is_special_td"] = (result["special"] == 1) & result["stat_id"].isin(
        td_ids_list
    )
